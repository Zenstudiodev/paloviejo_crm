                            ...
                            <div class="x_content">
                                <form class="form-horizontal form-label-left"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select>
                                                <option>Piso ceramico</option>
                                                <option>Azuejo</option>
                                                <option>Estuque</option>
                                                <option>Listelo</option>
                                                <option>Azulejo de baño</option>
                                                <option>Tipo de piso</option>
                                                <option>Tipo de madera</option>
                                                <option>Tipo de cocina</option>
                                                <option>Color de Mueble</option>
                                                <option>Color de Mueble</option>
