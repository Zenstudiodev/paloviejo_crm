                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form class="form-horizontal form-label-left"
                              action="<?php echo base_url(); ?>admin/actualizar_proyecto"
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Descripción <span
                                            class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <?= form_dropdown($estado, $estadoOptions, $proyecto->estado_proyecto) ?>
                                </div>
                            </div>
                            <input type="hidden" name="proyecto_id" value="<?php  echo $proyecto->proyecto_id?>">
