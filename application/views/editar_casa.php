                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form class="form-horizontal form-label-left"
                              action="<?php echo base_url(); ?>admin/actualizar_casa"
                            ...
                            $descripcion = array(
                                ...
                                'value' => $casa->control_casas_descripcion,
                                'type' => 'text',
                                'class' => 'form-control col-md-7 col-xs-12',
                                'required' => 'required'
                            );
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <?php echo form_dropdown($proyecto, $proyectoOptions, $casa->proyecto_id) ?>
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <input type="hidden" name="casa_id" value="<?php echo $casa->casa_id;?>">
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#tipo_casa").val('<?php echo $casa->tipo_casa_id?>');
            }
        });
    });
