            ...
            <div class="col-md-12">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <?php }?>
                        <a class="btn btn-success" href="<?php echo base_url().'admin/crear_usuario'?>">Crear usuario</a>
                            ...
                            foreach ($usuarios->result() as $usuario) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo base_url().'admin/desactivar_proyecto/'.$usuario->id; ?>"
                                           class="btn btn-success btn-xs"><i class="fa fa-file-text-o"></i> borrar </a>
